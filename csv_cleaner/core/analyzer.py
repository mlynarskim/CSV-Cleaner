...
def analyze_data(frame: pd.DataFrame) -> AnalysisResult:
    ...
    issues = [
        DataIssue(
            ...
            proposed_operation="action.remove_empty_rows",
        ),
        DataIssue(
            "empty_columns",
            "issue.empty_columns",
            ...
            proposed_operation="action.remove_empty_columns",
        ),
        DataIssue(
            "duplicates",
            "issue.duplicates",
            ...
            proposed_operation="action.remove_duplicates",
        ),
        DataIssue(
            "whitespace",
            "issue.whitespace",
            ...
            proposed_operation="action.trim",
        ),
        DataIssue(
            "missing",
            "issue.missing",
            ...
            proposed_operation="action.fill_missing",
        ),
        DataIssue(
            "invalid_emails",
            "issue.invalid_emails",
            invalid_email_count,
            columns=email_columns,
            examples=invalid_email_examples[:5],
            proposed_operation="action.validate_email",
        ),
    ]
